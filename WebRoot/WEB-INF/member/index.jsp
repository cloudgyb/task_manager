...
<html>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#lndiv li").click(function(){
			 	...
			 	else if($(this).index()==2){$("iframe").attr('src','${pageContext.request.contextPath}/member/gettaskgrade.action?uid=${sessionScope.task_user.uid}');}
			 	else if($(this).index()==3){$("iframe").attr('src','${pageContext.request.contextPath}/modifyuinfo.action');}
  ...
  <body>
  		...
  		<li id="userInfo" style="float: right;"><img id="user_head" src="<%=basePath%>img/user_head.jpg" alt="user_head" style="width: 40px;height: 40px;border-radius: 50%;cursor: pointer;line-height: 50px;" />
  			<div id="messBox" style="display: none;">
	  			...
	  			<div id="user_info">
	  				...
	  				<div id="box2">
	  					<div><a href="${pageContext.request.contextPath}/modifyuinfo.action">个人资料</a></div>
  	...
  	<!-- 内联框架———开始 -->
  	<div id="main">
  		<iframe src="${pageContext.request.contextPath}/member/getundonetask.action" width="100%" height="100%" frameborder="0"></iframe>
  	</div>
  	<!-- 内联框架———结束 -->
  	<script type="text/javascript">
  	</script>
